...
# Document status
define( 'DOCUMENT_STATUS_DISABLED', 0 );
define( 'DOCUMENT_STATUS_ENABLED', 1 );
...
define( 'ERROR_BUG_REVISION_NOT_FOUND', 1140 );

# ERROR_DWG_*
define( 'ERROR_DWG_NOT_FOUND', 1150 );
define( 'ERROR_DWG_DUPLICATE_SELF', 1151 );
define( 'ERROR_DWG_READ_ONLY_ACTION_DENIED', 1153 );
define( 'ERROR_DWG_RESOLVE_DEPENDANTS_BLOCKING', 1154 );
define( 'ERROR_DWG_CONFLICTING_EDIT', 1155 );
define( 'ERROR_DWG_REVISION_NOT_FOUND', 1190 );
...
# ERROR_DOCUMENT_*
define( 'ERROR_DOCUMENT_DUPLICATE', 1550 );
define( 'ERROR_DOCUMENT_NO_COPY_ACTION', 1551 );
define( 'ERROR_DOCUMENT_NOT_FOUND', 1552 );
define( 'ERROR_DOCUMENT_NOT_FOUND_FOR_PROJECT', 1553 );
define( 'ERROR_DOCUMENT_CANNOT_UPDATE_DEFAULT', 1554 );
define( 'ERROR_DOCUMENT_CANNOT_DELETE_HAS_ISSUES', 1555 );
...
define( 'ERROR_RELATIONSHIP_ACCESS_LEVEL_TO_DEST_DWG_TOO_LOW', 1804 );
define( 'ERROR_RELATIONSHIP_SAME_DWG', 1805 );
