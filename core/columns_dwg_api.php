 ...
 */
function columns_dwg_filter_disabled( array $p_columns ) {
	$t_columns = array();
...
function columns_dwg_get_standard( $p_enabled_columns_only = true ) {
	...
	if( $p_enabled_columns_only ) {
		$t_column_names = columns_dwg_filter_disabled( $t_column_names );
	}
 ...
 */
function columns_dwg_get_plugin_columns() {
 ...
 */
function columns_dwg_get_custom_fields() {
 ...
 * @return boolean
 */
function column_dwg_is_plugin_column( $p_column ) {
 ...
 * @access public
 */
function columns_dwg_get_all( $p_project_id = null ) {
	$t_columns = columns_dwg_get_standard();

	# add plugin columns
	$t_columns = array_merge( $t_columns, array_keys( columns_dwg_get_plugin_columns() ) );
 ...
 * @access public
 */
function column_dwg_is_extended( $p_column ) {
	switch( $p_column ) {
		case 'description':
 ...
 */
function column_dwg_is_custom_field( $p_column ) {
	$t_cf_columns = columns_dwg_get_custom_fields();
 ...
 */
function column_dwg_is_sortable( $p_column ) {

	# custom fields are always sortable
	if( column_dwg_is_custom_field( $p_column ) ) {
		return true;
	}

	# plugin fields contains a 'sortable' property
	if( column_dwg_is_plugin_column( $p_column ) ) {
		$t_plugin_columns = columns_dwg_get_plugin_columns();
 ...
 * @access public
 */
function column_dwg_get_custom_field_name( $p_column ) {
 ...
 */
function column_dwg_get_custom_field_column_name( $p_cf_id ) {
 ...
 * @access public
 */
function columns_dwg_string_to_array( $p_string ) {
 ...
 * @access public
 */
function columns_dwg_ensure_valid( $p_field_name, array $p_columns_to_validate, array $p_columns_all ) {
 ...
 * @access public
 */
function columns_dwg_remove_invalid( array $p_columns, array $p_columns_all ) {
 ...
 * @access public
 */
function print_dwg_column_title_selection( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_edit( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_id( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-id">';
	print_view_dwg_sort_link( lang_get( 'id' ), 'id', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_project_id( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-project-id">';
	print_view_dwg_sort_link( lang_get( 'email_project' ), 'project_id', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_handler_id( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-assigned-to">';
	print_view_dwg_sort_link( lang_get( 'assigned_to' ), 'handler_id', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_priority( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	...
	print_view_dwg_sort_link( $t_label, 'priority', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_reproducibility( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-reproducibility">';
	print_view_dwg_sort_link( lang_get( 'reproducibility' ), 'reproducibility', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_projection( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-projection">';
	print_view_dwg_sort_link( lang_get( 'projection' ), 'projection', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_eta( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-eta">';
	print_view_dwg_sort_link( lang_get( 'eta' ), 'eta', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_resolution( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-resolution">';
	print_view_dwg_sort_link( lang_get( 'resolution' ), 'resolution', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_fixed_in_version( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-fixed-in-version">';
	print_view_dwg_sort_link( lang_get( 'fixed_in_version' ), 'fixed_in_version', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_tags( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_target_version( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-target-version">';
	print_view_dwg_sort_link( lang_get( 'target_version' ), 'target_version', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_view_state( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-view-state">';
	$t_view_state_text = lang_get( 'view_status' );
	print_view_dwg_sort_link( $t_view_state_text, 'view_state', $p_sort, $p_dir, $p_columns_target, 'fa-lock' );
 ...
 * @access public
 */
function print_dwg_column_title_os( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-os">';
	print_view_dwg_sort_link( lang_get( 'os' ), 'os', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_os_build( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-os-build">';
	print_view_dwg_sort_link( lang_get( 'os_build' ), 'os_build', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_build( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	if( $p_columns_target != COLUMNS_TARGET_CSV_PAGE ) {
		echo '<th class="column-build">';
		print_view_dwg_sort_link( lang_get( 'build' ), 'build', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_platform( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-platform">';
	print_view_dwg_sort_link( lang_get( 'platform' ), 'platform', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_version( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-version">';
	print_view_dwg_sort_link( lang_get( 'product_version' ), 'version', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_date_submitted( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-date-submitted">';
	print_view_dwg_sort_link( lang_get( 'date_submitted' ), 'date_submitted', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_attachment_count( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_category_id( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-category">';
	print_view_dwg_sort_link( lang_get( 'category' ), 'category_id', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_category( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_sponsorship_total( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo "\t<th class=\"column-sponsorship\">";
	print_view_dwg_sort_link( sponsorship_get_currency(), 'sponsorship_total', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_severity( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-severity">';
	print_view_dwg_sort_link( lang_get( 'severity' ), 'severity', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_last_updated( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-last-modified">';
	print_view_dwg_sort_link( lang_get( 'updated' ), 'last_updated', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_description( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_steps_to_reproduce( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_additional_information( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
 ...
 * @access public
 */
function print_dwg_column_title_due_date( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-due-date">';
	print_view_dwg_sort_link( lang_get( 'due_date' ), 'due_date', $p_sort, $p_dir, $p_columns_target );
 ...
 * @access public
 */
function print_dwg_column_title_overdue( $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-overdue">';
	$t_overdue_text = lang_get( 'overdue' );
	print_view_dwg_sort_link( $t_overdue_text, 'due_date', $p_sort, $p_dir, $p_columns_target, 'fa-clock-o' );
	print_sort_icon( $p_dir, $p_sort, 'due_date' );
	echo '</th>';
}
 ...
 * @access public
 */
function print_dwg_column_title_plugin( $p_column, $p_column_object, $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE ) {
	echo '<th class="column-plugin">';
	if( $p_column_object->sortable ) {
		print_view_dwg_sort_link( string_display_line( $p_column_object->title ), $p_column, $p_sort, $p_dir, $p_columns_target );
