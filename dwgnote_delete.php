...
form_security_validate( 'dwgnote_delete' );

$f_bugnote_id = gpc_get_int( 'bugnote_id' );

helper_ensure_confirmed( lang_get( 'delete_dwgnote_sure_msg' ),
						 lang_get( 'delete_dwgnote_button' ) );
...
print_dwg_header_redirect( string_get_bug_view_url( $t_result['issue_id'] ) . '#bugnotes' );
