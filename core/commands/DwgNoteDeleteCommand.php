 ...
 */
class DwgNoteDeleteCommand extends Command {
    /**
	...
	function validate() {
        ...
        $t_project_id = dwg_get_field( $this->issueId, 'project_id' );
        ...
        if( bug_is_readonly( $this->issueId ) ) {
			throw new ClientException(
				sprintf( "Document '%d' is read-only.", $this->issueId ),
