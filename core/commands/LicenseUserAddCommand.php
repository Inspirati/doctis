...
/**
 * A command to add a user to a license or update their access to a license.
 */
class LicenseUserAddCommand extends Command {
	/**
	...
	protected function process() {
		...
		license_add_user( $this->license_id, $this->user_id, $this->access_level );
	}
}
