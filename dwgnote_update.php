...
dwgnote_set_text( $f_bugnote_id, $f_bugnote_text );
dwgnote_set_time_tracking( $f_bugnote_id, $f_time_tracking );

# Plugin integration
event_signal( 'EVENT_DWGNOTE_EDIT', array( $t_bug_id, $f_bugnote_id ) );
