 ...
 * @subpackage classes
 */
class DwgCreatedTimelineEvent extends TimelineEvent {
	private $issue_id;
	...
	public function html() {
		...
		$t_html .= '<div class="action">' . sprintf( lang_get( 'timeline_document_created' ), prepare_user_name( $this->user_id ), string_get_dwg_view_link( $this->issue_id ) ) . '</div>';
