...
function error_map_mantis_error_to_http_code( $p_error ) {
	switch( $p_error ) {
		...
		case ERROR_DWG_DUPLICATE_SELF:
		case ERROR_BUG_RESOLVE_DEPENDANTS_BLOCKING:
		case ERROR_DWG_RESOLVE_DEPENDANTS_BLOCKING:
		case ERROR_BUG_CONFLICTING_EDIT:
		case ERROR_DWG_CONFLICTING_EDIT:
		...
		case ERROR_DOCUMENT_DUPLICATE:
		case ERROR_NO_COPY_ACTION:
		case ERROR_DOCUMENT_NO_COPY_ACTION:
		case ERROR_CATEGORY_NOT_FOUND_FOR_PROJECT:
		case ERROR_DOCUMENT_NOT_FOUND_FOR_PROJECT:
		...
		case ERROR_RELATIONSHIP_SAME_DWG:
		...
		case ERROR_DWG_NOT_FOUND:
		case ERROR_FILE_NOT_FOUND:
		case ERROR_BUGNOTE_NOT_FOUND:
		case ERROR_DWGNOTE_NOT_FOUND:
		...
		case ERROR_DWG_REVISION_NOT_FOUND:
		...
		case ERROR_DWG_READ_ONLY_ACTION_DENIED:
		...
		case ERROR_RELATIONSHIP_ACCESS_LEVEL_TO_DEST_DWG_TOO_LOW:
