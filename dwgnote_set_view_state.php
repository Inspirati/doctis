...
form_security_validate( 'dwgnote_set_view_state' );
...
if( $t_user_id == auth_get_current_user_id() ) {
	...
	access_ensure_dwgnote_level( config_get( 'change_view_status_threshold' ), $f_bugnote_id );
}

dwg_activity_bugnote_link_attachments( $f_bugnote_id );
dwgnote_set_view_state( $f_bugnote_id, $f_private );

form_security_purge( 'dwgnote_set_view_state' );

print_dwg_header_redirect( string_get_bug_view_url( $t_bug_id ) . '#bugnotes' );
