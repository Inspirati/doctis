...
function email_format_dwg_message( array $p_visible_bug_data ) {
	...
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_creator' );
	...
	$t_message .= email_format_attribute( $p_visible_bug_data, 'email_dwg' );
...
function email_build_visible_dwg_data( $p_user_id, $p_bug_id, $p_message_id ) {
	...
	# description comes from dwg_text (available via dwg_get_extended_row)
