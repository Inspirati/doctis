...
layout_page_begin( 'manage_filter_dwg_edit_page.php', true );
...
$t_action = 'manage_filter_dwg_edit_update.php';
$t_current_project_id = helper_get_current_project();
$t_filter_project_id = filter_dwg_get_field( $f_filter_id, 'project_id' );
			...
			<div class="widget-toolbar">
				<div class="widget-menu">
					...
					<ul class="dropdown-menu dropdown-menu-right dropdown-yellow dropdown-caret dropdown-closer">
						<?php
							$t_url = 'manage_filter_dwg_edit_page.php?filter_id=' . $f_filter_id . '&view_type=';
		...
		<div class="widget-body">
			<div class="widget-main no-padding">
					...
					<div class="btn-toolbar pull-left">
						<div class="form-inline">
							<label>
								...
								<input type="text" size="25" name="filter_name" maxlength="64" value="<?php echo string_display_line( filter_dwg_get_field( $f_filter_id, 'name' ) ) ?>">
							</label>
						</div>
					</div>
				</div>
				...
				<div class="table-responsive">
					...
					filter_dwg_form_draw_inputs( $t_filter, $t_for_screen, $t_static );
					?>
				</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-condensed table-striped">
						...
						<tr>
							...
							<td>
								<label>
									<input type="radio" class="ace" name="is_public" value="1" <?php check_checked( (bool)filter_dwg_get_field( $f_filter_id, 'is_public' ), true ) ?> />
									<span class="lbl padding-6"><?php echo lang_get( 'public' ) ?></span>
								</label>
								&#160;&#160;&#160;&#160;
								<label>
									<input type="radio" class="ace" name="is_public" value="0" <?php check_checked( (bool)filter_dwg_get_field( $f_filter_id, 'is_public' ), false ) ?> />
