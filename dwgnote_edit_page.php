...
$t_bugnote_text = string_textarea( dwgnote_get_text( $f_bugnote_id ) );

# No need to gather the extra information if not used
if( config_get( 'time_tracking_enabled' ) &&
	access_has_dwg_level( config_get( 'time_tracking_edit_threshold' ), $t_bug_id ) ) {
	$t_time_tracking = dwgnote_get_field( $f_bugnote_id, 'time_tracking' );
	$t_time_tracking = db_minutes_to_hhmm( $t_time_tracking );
}

# Determine which view page to redirect back to.
$t_redirect_url = string_get_dwg_view_url( $t_bug_id );
...
<?php if( access_has_dwg_level( config_get( 'time_tracking_edit_threshold' ), $t_bug_id ) ) { ?>
<tr>
...
<?php event_signal( 'EVENT_DWGNOTE_EDIT_FORM', array( $t_bug_id, $f_bugnote_id ) ); ?>
