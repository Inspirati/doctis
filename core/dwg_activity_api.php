 ...
 */
function dwg_activity_get_all( $p_bug_id, $p_include_attachments = true ) {
	$t_result = array();
	...
	dwg_activity_sort( $t_activities );
	$t_activities = dwg_activity_combine( $t_activities );
 ...
 */
function dwg_activity_combine( $p_entries ) {
