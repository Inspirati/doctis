...
$f_file_id = gpc_get_int( 'file_id', 0 );
$f_type	= gpc_get_string( 'type' );

# Primary document files — separate path; id parameter is the dwg_id, not a file row id.
if( $f_type === 'dwg_primary' ) {
	...
	$t_filename     = file_get_display_name( $t_row['filename'] );
