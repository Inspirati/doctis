...
function print_filter_dwg_creator_id( ?array $p_filter = null ) {
	...
	if( access_has_limited_view_dwg() ) {
		...
		?>
		<option value="<?php echo META_FILTER_ANY?>"<?php check_selected( $p_filter[FILTER_PROPERTY_CREATOR_ID], META_FILTER_ANY );?>>[<?php echo lang_get( 'any' )?>]</option>
		<?php
			if( access_has_project_level( config_get( 'create_dwg_threshold' ) ) ) {
				echo '<option value="' . META_FILTER_MYSELF . '" ';
				check_selected( $p_filter[FILTER_PROPERTY_CREATOR_ID], META_FILTER_MYSELF );
				echo '>[' . lang_get( 'myself' ) . ']</option>';
			}
		print_dwg_creator_option_list( $p_filter[FILTER_PROPERTY_CREATOR_ID] );
	}?>
		</select>
		<?php
}
 ...
 * @return void
 */
function print_filter_dwg_values_user_monitor( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
	$t_none_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_user_monitor( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_handler_id( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_handler_id( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_category( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
	$t_none_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_category( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_platform( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_os( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_os_build( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_severity( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_severity( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_resolution( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_resolution( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_status( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_status( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_hide_status( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_none_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_hide_status( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_build( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_build( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_version( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_version( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_fixed_in_version( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_fixed_in_version( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_target_version( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_target_version( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_show_priority( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_priority( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 */
function print_filter_dwg_values_show_profile( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_profile( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_per_page( array $p_filter ) {
	$t_filter = $p_filter;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_per_page( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_view_state( array $p_filter ) {
	$t_filter = $p_filter;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_view_state( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 */
/*
// function print_filter_dwg_values_sticky_issues( array $p_filter ) {
// 	$t_filter = $p_filter;
...
// }
 */
function print_filter_dwg_values_sticky_documents( array $p_filter ) {
	$t_filter = $p_filter;
	$t_sticky_filter_state = gpc_string_to_bool( $t_filter[FILTER_PROPERTY_STICKY] );
	print( $t_sticky_filter_state ? lang_get( 'yes' ) : lang_get( 'no' ) );
	?>
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_sticky_documents( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_highlight_changed( array $p_filter ) {
	$t_filter = $p_filter;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_highlight_changed( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_do_filter_by_date( array $p_filter ) {
	$t_filter = $p_filter;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_do_filter_by_date( $p_hide_checkbox = false, ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_do_filter_by_last_updated_date( array $p_filter ) {
	$t_filter = $p_filter;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_do_filter_by_last_updated_date( $p_hide_checkbox = false, ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @throws ClientException
 */
function print_filter_dwg_values_relationship_type( array $p_filter ) {
	$t_filter = $p_filter;
	...
	echo '<input type="hidden" name="', FILTER_PROPERTY_RELATIONSHIP_DWG, '" value="', string_attribute( $t_filter[FILTER_PROPERTY_RELATIONSHIP_DWG] ), '" />';
	$c_rel_type = $t_filter[FILTER_PROPERTY_RELATIONSHIP_TYPE];
	$c_rel_bug = $t_filter[FILTER_PROPERTY_RELATIONSHIP_DWG];
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_relationship_type( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
	...
	echo '<input class="input-xs" type="text" name="', FILTER_PROPERTY_RELATIONSHIP_DWG, '" size="5" maxlength="10" value="', $p_filter[FILTER_PROPERTY_RELATIONSHIP_DWG], '" />';
}
 ...
 * @return void
 */
function print_filter_dwg_values_tag_string( array $p_filter ) {
	$t_filter = $p_filter;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_tag_string( ?array $p_filter = null ) {
	global $g_dwg_filter;
 ...
 * @return void
 */
function print_filter_dwg_values_note_user_id( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_note_user_id( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_plugin_field( array $p_filter, $p_field_name, $p_filter_object ) {
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_plugin_field( $p_field_name, $p_filter_object, ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_custom_field_date( array $p_filter, $p_field_id ) {
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_custom_field( $p_field_id, ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_show_sort( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
	...
	$t_visible_columns = array_filter( helper_get_dwg_columns_to_view(), 'column_dwg_is_sortable' );
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_custom_field_date( $p_field_id, ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_project_id( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_project_id( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_projection( array $p_filter ) {
	$t_filter = $p_filter;
	$t_output = '';
	$t_any_found = false;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_projection( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
 ...
 * @return void
 */
function print_filter_dwg_values_match_type( array $p_filter ) {
	$t_filter = $p_filter;
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_match_type( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
...
function filter_dwg_form_draw_inputs( $p_filter, $p_for_screen = true, $p_static = false, $p_static_fallback_page = null, $p_show_search = true ) {
	...
	$t_row1 = new FilterDwgBoxGridLayout( $t_filter_cols , TableGridLayout::ORIENTATION_VERTICAL );

	$t_row1->add_item( new TableFieldsItem(
			$get_field_header( 'creator_id_filter', lang_get( 'creator' ) ),
			filter_dwg_form_get_input( $t_filter, 'creator_id', $t_show_inputs ),
			1 /* colspan */,
			null /* class */,
			'creator_id_filter_target' /* content id */
			));
	$t_row1->add_item( new TableFieldsItem(
	...
	$t_row1->add_item( new TableFieldsItem(
			$get_field_header( 'sticky_dwgs_filter', lang_get( 'dwg_sticky' ) ),
			filter_dwg_form_get_input( $t_filter, 'sticky_documents', $t_show_inputs ),
			1 /* colspan */,
			null /* class */,
			'sticky_dwgs_filter_target' /* content id */
			));

	$t_row2 = new FilterDwgBoxGridLayout( $t_filter_cols , TableGridLayout::ORIENTATION_VERTICAL );
	...
	$t_row3 = new FilterDwgBoxGridLayout( $t_filter_cols , TableGridLayout::ORIENTATION_VERTICAL );
	...
	$t_section_last = new FilterDwgBoxGridLayout( $t_filter_cols , TableGridLayout::ORIENTATION_HORIZONTAL );
	...
	if( $p_show_search ) {
		$t_section_search = new FilterDwgBoxGridLayout( $t_filter_cols , TableGridLayout::ORIENTATION_HORIZONTAL );
 ...
 * filter form table
 */
class FilterDwgBoxGridLayout extends TableGridLayout {
 ...
 * @global array     $g_dwg_filter
 */
function print_filter_dwg_search( ?array $p_filter = null ) {
	global $g_dwg_filter;
	if( null === $p_filter ) {
		$p_filter = $g_dwg_filter;
	}
