...
switch( $f_type ) {
	...
	case FILTER_ACTION_RESET:
		log_event( LOG_FILTERING, 'view_dwg_set.php: New filter' );
		$t_setting_arr = array();
		break;
	...
	default:
		...
		log_event( LOG_FILTERING, 'view_dwg_set.php: default - do nothing' );
		break;
}

$t_setting_arr = filter_dwg_ensure_valid_filter( $t_setting_arr );
