...
form_security_validate( 'manage_license_create' );
...
// 	$t_redirect_url = 'manage_license_edit_page.php?project_id=' . $f_parent_id . '#subprojects';
// } else {
	$t_redirect_url = 'manage_license_page.php';
// }

form_security_purge( 'manage_license_create' );
