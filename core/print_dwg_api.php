 ...
 * @return boolean
 */
function print_dwg_header_redirect( $p_url, $p_die = true, $p_sanitize = false, $p_absolute = false ) {
	if( error_handled() ) {
 ...
 * @return void
 */
function print_dwg_avatar( $p_user_id, $p_class_prefix, $p_size = 80 ) {
 ...
 * @return void
 */
function print_dwg_user( $p_user_id, $p_link = true ) {
 ...
 * @return void
 */
function print_dwg_user_with_subject( $p_user_id, $p_bug_id ) {
 ...
 * @return void
 */
function print_dwg_email_input( $p_field_name, $p_email ) {
 ...
 * @return void
 */
function print_dwg_captcha_input( $p_field_name ) {
 ...
 * @return void
 */
function print_dwg_user_option_list( $p_user_id, $p_project_id = null, $p_access = ANYBODY ) {
 ...
 * @return boolean
 */
function print_dwg_tag_attach_form( $p_bug_id, $p_string = '' ) {
?>
...
/*
			<form method="post" action="dwg_license_update.php" class="form-inline noprint">
				...
				<input type="hidden" name="user_id" value="<?php echo (int)$t_current_user_id; ?>" />
				<input type="hidden" name="project_id" value="<?php echo (int)$t_issue['project']; ?>" />
 ...
 * @return void
 */
function print_dwg_tag_input( $p_bug_id = 0, $p_string = '' ) {
?>
	<label class="inline small">
		<?php printf( lang_get( 'tag_separate_by' ), config_get( 'tag_separator' ) )?>
	</label>
 ...
 * @return void
 */
function print_dwg_tagging_errors_table( $p_tags_failed ) {
	?>
 ...
 * @return void
 */
function print_dwg_news_item_option_list() {
 ...
 * @return void
 */
function print_dwg_news_entry( $p_headline, $p_body, $p_poster_id, $p_view_state, $p_announcement, $p_date_posted ) {
 ...
 * @return void
 */
function print_dwg_news_entry_from_row( array $p_news_row ) {
 ...
 * @return void
 */
function print_dwg_news_string_by_news_id( $p_news_id ) {
 ...
 * @return void
 */
function print_dwg_project_option_list( $p_project_id = null, $p_include_all_projects = true, $p_filter_project_id = null, $p_trace = false, $p_can_report_only = false ) {
 ...
 * @return void
 */
function print_dwg_subproject_option_list( $p_parent_id, $p_project_id = null, $p_filter_project_id = null, $p_trace = false, $p_can_report_only = false, array $p_parents = array() ) {
 ...
 * @return void
 */
function print_dwg_profile_option_list( $p_user_id, $p_select_id = 0, ?array $p_profiles = null ) {
	if( 0 == $p_select_id ) {
 ...
 * @return void
 */
function print_dwg_profile_option_list_for_project( $p_project_id, $p_select_id = 0, ?array $p_profiles = null ) {
	if( 0 == $p_select_id ) {
 ...
 * @return void
 */
function print_dwg_profile_option_list_from_profiles( array $p_profiles, $p_select_id ) {
 ...
 * @return void
 */
function print_dwg_category_option_list( $p_category_id = 0, $p_project_id = null, $p_enabled_only = false ) {
	if( null === $p_project_id ) {
		$t_project_id = helper_get_current_project();
	} else {
 ...
 * @return void
 */
function print_dwg_category_filter_option_list( $p_category_name = '', $p_project_id = null ) {
 ...
 * @return void
 */
function print_dwg_platform_option_list( $p_platform, $p_user_id = null ) {
 ...
 * @return void
 */
function print_dwg_os_option_list( $p_os, $p_user_id = null ) {
 ...
 * @return void
 */
function print_dwg_os_build_option_list( $p_os_build, $p_user_id = null ) {
 ...
 * @return void
 */
function print_dwg_version_option_list( $p_version = '', $p_project_ids = null, $p_released = VERSION_ALL, $p_leading_blank = true ) {
 ...
 * @return void
 */
function print_dwg_build_option_list( $p_build = '' ) {
 ...
 * @return void
 */
function print_dwg_enum_string_option_list( $p_enum_name, $p_val = 0 ) {
 ...
 * @return void
 */
function print_dwg_status_option_list( $p_select_label, $p_current_value = 0, $p_allow_close = false, $p_project_id = ALL_PROJECTS ) {
	$t_current_auth = access_get_project_level( $p_project_id );

	$t_enum_list = print_dwg_get_status_option_list( $t_current_auth, $p_current_value, true, $p_allow_close, $p_project_id );
 ...
 * @return void
 */
function print_dwg_project_access_levels_option_list( $p_val, $p_project_id = null ) {
 ...
 * @return void
 */
function print_dwg_language_option_list( $p_language ) {
 ...
 * @return void
 */
function print_dwg_font_option_list( $p_font ) {
 ...
 * @return void
 */
function print_dwg_project_user_list_option_list( $p_project_id = null ) {
 ...
 * @return void
 */
function print_dwg_project_user_list_option_list2( $p_user_id ) {
	db_param_push();
 ...
 * @return void
 */
function print_dwg_custom_field_projects_list( $p_field_id ) {
 ...
 * @return void
 */
function print_dwg_plugin_priority_list( $p_priority ) {
 ...
 */
function print_view_dwg_sort_link( $p_label, $p_sort_field, $p_sort, $p_dir, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE, $p_icon = '' ) {
 ...
 * @return void
 */
function print_dwg_manage_user_sort_link( $p_page, $p_string, $p_field, $p_dir, $p_sort_by, $p_hide_inactive = 0, $p_filter = 'ALL', $p_search = '', $p_show_disabled = 0, $p_class = '' ) {
 ...
 * @return void
 */
function print_dwg_manage_project_sort_link( $p_page, $p_string, $p_field, $p_dir, $p_sort_by ) {
	if( $p_sort_by == $p_field ) {
		# If this is the selected field flip the order
		if( 'ASC' == $p_dir || ASCENDING == $p_dir ) {
			$t_dir = 'DESC';
 ...
 * @return void
 */
function print_dwg_form_button( $p_action_page, $p_label, array $p_args_to_post = [], $p_security_token = null, $p_class = '' ) {
 ...
 * @deprecated 2.21.0
 */
function print_dwg_bracket_link_prepared( $p_link ) {
	error_parameters(
		__FUNCTION__,
 ...
 * @return void
 */
function print_dwg_link_button( $p_link, $p_url_text, $p_class = '', $p_new_window = false ) {
	if( is_blank( $p_link ) ) {
		echo $p_url_text;
	} else {
		$t_link = htmlspecialchars( $p_link );
 ...
 * @return void
 */
function print_dwg_extra_small_button( $p_link, $p_url_text, $p_new_window = false ) {
	print_link_button( $p_link, $p_url_text, 'btn-xs', $p_new_window );
}

function print_dwg_small_button( $p_link, $p_url_text, $p_new_window = false ) {
 ...
 * @return void
 */
function print_dwg_page_link( $p_page_url, $p_text = '', $p_page_no = 0, $p_page_cur = 0, $p_temp_filter_key = null ) {
	if( is_blank( $p_text ) ) {
		$p_text = $p_page_no;
	}
 ...
 * @return void
 */
function print_dwg_page_links( $p_page, $p_start, $p_end, $p_current, $p_temp_filter_key = null ) {
	$t_items = array();
 ...
 * @return void
 */
function print_dwg_email_link( $p_email, $p_text ) {
 ...
 * @return void
 */
function print_dwg_hidden_inputs( array $p_assoc_array ) {
 ...
 * @return void
 */
function print_dwg_hidden_input( $p_field_key, $p_field_val ) {
 ...
 * @return void
 */
function print_dwg_documentation_link( $p_a_name = '' ) {
 ...
 * @return void
 */
function print_dwg_signup_link() {
 ...
 * @return void
 */
function print_dwg_lost_password_link() {
 ...
 * @return void
 */
function print_dwg_rss( $p_feed_url, $p_title = '' ) {
 ...
 * @return void
 */
function print_dwg_timezone_option_list( $p_timezone ) {
 ...
 * @return void
 */
function print_dwg_dropzone_form_data() {
 ...
 * @return void
 */
function print_dwg_dropzone_template(){
	?>
 ...
 * @return void
 */
function print_dwg_option_list_from_array( array $p_array, $p_filter_value ) {
 ...
 * @return void
 */
function print_dwg_table_spacer( int $p_cols ) {
	if( $p_cols > 0 ) {
