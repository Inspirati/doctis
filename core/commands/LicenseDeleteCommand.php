 ...
 */
class LicenseDeleteCommand extends Command {
	/**
	...
	function validate() {
		...
		if( !access_has_license_level( config_get( 'delete_license_threshold', null, $t_user_id, $this->id ) ) ) {
			throw new ClientException(
				'Access denied to delete license',
				ERROR_ACCESS_DENIED );
		}
	...
	protected function process() {
		...
		event_signal( 'EVENT_MANAGE_LICENSE_DELETE', array( $this->id ) );

		license_delete( $this->id );
		return [];
	}
}
