...
('merry',   'Meriadoc Brandybuck', 'merry@shire.example', 'd41d8cd98f00b204e9800998ecf8427e', 1, 0, 40, 0, 0, 0, 'd4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5', 1757927188, 1757927188, 'Rider of Rohan',          'The Fellowship', '+64 9 000 0003', 'Rohan',           1, ''),
