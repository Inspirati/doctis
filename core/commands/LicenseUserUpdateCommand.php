 ...
 */
class LicenseUserUpdateCommand extends Command {
	/**
	...
	function validate() {
		...
		$this->access_level = $t_access_level;
	...
	protected function process() {
		...
		license_update_user_access( $this->license_id, $this->user_id, $this->access_level );
	}
}
