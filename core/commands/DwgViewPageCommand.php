...
//function mci_issue_data_as_array( BugData $p_issue_data, $p_user_id, $p_lang, $p_fields = null ) {
		...
		// 	!$t_issue_readonly &&
		// 	access_has_dwg_level( config_get( 'bug_reminder_threshold' ), $t_issue_id );
		...
		// 	$t_flags['monitor_can_delete'] = access_has_dwg_level( config_get( 'monitor_delete_others_bug_threshold' ), $t_issue_id );
		// 	$t_flags['monitor_can_add'] = access_has_dwg_level( config_get( 'monitor_add_others_bug_threshold' ), $t_issue_id );
		// }
		...
		// 		access_has_dwg_level( config_get( 'monitor_bug_threshold' ), $t_issue_id );
		...
		// 	access_has_dwg_level( config_get( 'update_bug_assign_threshold', config_get( 'update_dwg_threshold' ) ), $t_issue_id );
		// $t_flags['can_change_status'] = !$t_issue_readonly && access_has_dwg_level( config_get( 'update_bug_status_threshold' ), $t_issue_id );

		// $t_flags['can_clone'] = !$t_issue_readonly && access_has_dwg_level( config_get( 'report_bug_threshold' ), $t_issue_id );
		...
		// 	access_can_close_bug( $t_issue_data ) && dwg_check_workflow( $t_issue_data->status, $t_closed_status );

		// $t_flags['can_move'] = !$t_issue_readonly && user_has_more_than_one_project( $t_user_id ) &&
		// 	access_has_dwg_level( config_get( 'move_bug_threshold' ), $t_issue_id );
		// $t_flags['can_delete'] = !$t_issue_readonly && access_has_dwg_level( config_get( 'delete_bug_threshold' ), $t_issue_id );
		...
		// 	$t_sticky_change = access_has_dwg_level( config_get( 'set_bug_sticky_threshold' ), $t_issue_id );
