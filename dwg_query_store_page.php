...
# filter_dwg_serialize will remove runtime properties, so they can compare
# @TODO cproensa, implement a better method to compare filters? is it used besides here?
$t_query_to_store = filter_dwg_serialize( $t_filter );
...
foreach( $t_query_arr as $t_id => $t_name ) {
	if( filter_dwg_db_get_filter_string( $t_id ) == $t_query_to_store ) {
...
<form method="post" action="dwg_query_store.php" class="form-inline">
<?php
echo form_security_field( 'dwg_query_store' );
